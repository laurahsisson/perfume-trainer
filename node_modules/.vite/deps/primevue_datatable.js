...
function render21(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps({
    ...
    clipPath: "url(#".concat($options.pathId, ")")
  }, _hoisted_68, 8, _hoisted_119), createBaseVNode("defs", null, [createBaseVNode("clipPath", {
    id: "".concat($options.pathId)
...
function render22(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps({
    ...
    clipPath: "url(#".concat($options.pathId, ")")
  }, _hoisted_82, 8, _hoisted_120), createBaseVNode("defs", null, [createBaseVNode("clipPath", {
    id: "".concat($options.pathId)
...
function render23(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps({
    ...
    clipPath: "url(#".concat($options.pathId, ")")
  }, _hoisted_83, 8, _hoisted_121), createBaseVNode("defs", null, [createBaseVNode("clipPath", {
    id: "".concat($options.pathId)
