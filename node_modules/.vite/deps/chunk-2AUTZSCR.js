...
var loadGlobalStyle = _useStyle2.load;
var script = {
  name: "BaseComponent",
  props: {
    pt: {
  ...
  methods: {
    ...
    _getPTValue: function _getPTValue() {
      ...
      var self = searchOut ? void 0 : this._usePT(this._getPT(obj, this.$name), this._getPTClassValue, key, params);
      ...
      var merged = mergeProps(self, globalPT2, key !== "transition" && _objectSpread(_objectSpread({}, key === "root" && _defineProperty({}, "".concat(datasetPrefix, "name"), ObjectUtils.toFlatCase(this.$.type.name))), {}, _defineProperty({}, "".concat(datasetPrefix, "section"), ObjectUtils.toFlatCase(key))));
      return merged;
    },
...
//# sourceMappingURL=chunk-2AUTZSCR.js.map
